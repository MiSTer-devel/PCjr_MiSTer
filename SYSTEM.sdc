...
# Clocks - PLL system (CPU/Video domain - precise frequencies)
set CLOCK_VGA_CGA   {emu|pll_system_inst|pll_system_inst|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}
set CLOCK_4_77      {emu|pll_system_inst|pll_system_inst|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}

# Derived clocks (from PLL system domain)
set CLOCK_14_318    {emu|clk_14_318|q}
set PCLK            {emu|peripheral_clock|q}

# clk_14_318 derives from clk_28_636 (PLL system - precise frequency)
create_generated_clock -name clk_14_318 -source [get_pins $CLOCK_VGA_CGA] -divide_by 2 [get_pins $CLOCK_14_318]
# peripheral_clock derives from clk_4_77
...
# CDC: PLL principal (Chipset) <-> PLL system (CPU/Video) - asynchronous clock domains
